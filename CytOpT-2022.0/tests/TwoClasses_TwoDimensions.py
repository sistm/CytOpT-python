...
from CytOpT.cytopt_plot import plot_py_1, plot_py_2, plot_py_prop1, plot_py_prop2, plot_py_3, plot_py_4
...
class TwoClassesTwoDimension():
    ...
    def init_class_proportions(self):
        ...
        plot_py_1(self.data['X_source'], self.data['X_target'], self.data['Lab_source'], 100 * h_source,
                  self.data['names_pop'])
    ...
    def optimal_transport(self):
        ...
        plot_py_2(self.data['X_tar_display'], Lab_target_hat_one, self.data['Lab_target'], self.data['names_pop'])
    ...
    def optimal_reweighted(self):
        ...
        plot_py_3(self.data['X_tar_display'], optimal_return['Lab_target_hat_one'], self.data['names_pop'],
                  Lab_target_hat_two,
                  self.data['Lab_target'])
    ...
    def optimal_without_reweighted(self):
        ...
        plot_py_4(self.data['X_sou_display'], self.data['Lab_source'], self.data['names_pop'], X_target_lag, n_sub,
                  indices, indices_two)
