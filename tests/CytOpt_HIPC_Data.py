...
class cytOpt_HIPC_Data:
    ...
    def cytOpt_HIPC(self):
        ...
        Results_Desasc = CytOpT(X_source, X_target, Lab_source,
                                method="desasc", n_it_grad=n_out, n_it_sto=n_stoc, step_grad=step_grad, eps=eps)
        ...
        Results_Minmax = CytOpT(X_source, X_target, Lab_source, eps=0.0001, lbd=0.0001, n_iter=n_iter,
                                method="minmax", theta_true=theta_true, step=step_grad, power=power, monitoring=False)
